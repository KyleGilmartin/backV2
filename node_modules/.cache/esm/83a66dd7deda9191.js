let userService,crypto,config,User,axios;_ded‍.x([["default",()=>_ded‍.o]]);_ded‍.w("../models/userService",[["default",["userService"],function(v){userService=v}]]);_ded‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_ded‍.w("../config",[["default",["config"],function(v){config=v}]]);_ded‍.w("../models/userModel",[["User",["User"],function(v){User=v}]]);_ded‍.w("axios",[["default",["axios"],function(v){axios=v}]]);
...
function isValidFaceBookUser(req, res, next) {
    ...
    _ded‍.g.console.log('access token from client: ' + accessToken)

    getFacebookData(accessToken).then(
            (data) => {
                _ded‍.g.console.log(' facebook data ' + JSON.stringify(data));
